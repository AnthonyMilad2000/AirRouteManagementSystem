        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxRangeKm = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AirCraftSubImgs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AirCraftId = table.Column<int>(type: "int", nullable: false),
                    SubImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AirCraftSubImgs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AirCraftSubImgs_Aircrafts_AirCraftId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AirCraftSubImgs_AirCraftId",
                table: "AirCraftSubImgs",
                column: "AirCraftId");
