// <auto-generated />
using System;
using AirRouteManagementSystem.DataAccess.Context;
...
namespace AirRouteManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20260212000432_change-UserId-type-in-booking-model")]
    partial class changeUserIdtypeinbookingmodel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.AirCraftSubImg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.ApplicationUserOTP", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.Customer.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.Customer.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.AirCraftSubImg", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.Aircraft", null)
                        .WithMany("SubImages")
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.ApplicationUserOTP", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.Customer.Booking", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.Flight", "Flight")
                        .WithMany()
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.Flight", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.Airport", "FromAirport")
                        .WithMany()
                        .HasForeignKey("FromAirportId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AirRouteManagementSystem.Model.Airport", "ToAirport")
                        .WithMany()
            ...
            modelBuilder.Entity("AirRouteManagementSystem.Model.FlightPrice", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.Flight", null)
                        .WithMany("FlightPrice")
                        .HasForeignKey("FlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AirRouteManagementSystem.Model.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
